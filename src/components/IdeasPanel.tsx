...
export function IdeasPanel({ ideas, onAdd, onRemove }: IdeasPanelProps) {
    ...
    <div className="flex flex-col gap-4 rounded-xl border border-zinc-800 bg-zinc-900/50 p-4">
      ...
      <ul className="flex max-h-64 flex-col gap-2 overflow-y-auto">
        ...
        {ideas.map((idea) => (
          <li
            key={idea.id}
            className="group flex items-start gap-2 rounded-lg border border-zinc-800 bg-zinc-950/50 px-3 py-2"
          >
